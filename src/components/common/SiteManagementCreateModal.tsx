...
export default function SiteManagementCreateModal({ open, onClose, title }: Props) {
  const { setField, form, reset } = useSiteManamentFormStore()
  ...
  const { createSiteManamentMutation } = useSiteManament()

  useEffect(() => {
    if (createSiteManamentMutation.isSuccess) {
      onClose()
    }
  }, [createSiteManamentMutation.isSuccess, onClose])
      ...
      <div className="bg-white rounded-lg shadow-xl w-[90%] max-w-6xl p-6 border border-gray-700">
        ...
        <div className="flex justify-end gap-3 mt-6">
          ...
          <button
            ...
            onClick={() => {
              createSiteManamentMutation.mutate(undefined, {})
            }}
          >
            등록
          </button>
