...
export const SteelExcelFieldMap = {
  ...
  현장명: 'siteName',
  공정명: 'siteProcessName',
  '입고 자사(톤/합계)': 'incomingOwnMaterial',
  '입고 구매(톤/합계)': 'incomingPurchase',
  '입고 임대(톤/합계)': 'incomingRental',
  '출고 자사(톤/합계)': 'outgoingOwnMaterial',
  '출고 구매(톤/합계)': 'outgoingPurchase',
  '출고 임대(톤/합계)': 'outgoingRental',
  '사장(톤)': 'onSiteStock',
  '고철(톤/합계)': 'scrap',
